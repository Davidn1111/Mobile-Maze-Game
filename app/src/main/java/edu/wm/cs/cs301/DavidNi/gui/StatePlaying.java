...
public class StatePlaying {
    ...
    // Current Playing Activity corresponding to StatePlaying
    PlayingActivity playActivity;
    ...
    public StatePlaying(PlayingActivity activity) {
        started = false;
	...
	protected void startDrawer() {
		...
		mapView = new Map(seenCells, 105, mazeConfig) ;
